...
def gen_pir_layer():
    ...
    pir[9].mins[0]=average_pir[0][0];
    pir[9].mins[1]=average_pir[1][0];
    pir[9].maxs[0]=average_pir[0][3];
    pir[9].maxs[1]=average_pir[1][3];
    for i in range (9):
        pir[i].mins[0]=average_pir[0][i%3];
        pir[i].mins[1]=average_pir[1][2-i/3];
        pir[i].maxs[0]=average_pir[0][i%3+1];
        pir[i].maxs[1]=average_pir[1][3-i/3];
    '''
...
def gen_pir():
    global pir;   
    gen_average();
    pir=[pir_type([0,0],[0,0]) for i in range(10)];
